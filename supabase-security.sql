...
select 1, candidate.name, candidate.group_name, candidate.position, candidate.initials, candidate.description
from (values
  ('Maria Santos', 'Uniteam', 'PRESIDENT', 'MS', 'Leadership with integrity, service with heart.'),
  ('Juan Dela Cruz', 'Uniteam', 'VICE PRESIDENT', 'JD', 'Together, we can build a better OLLC.'),
  ('Ana Reyes', 'Uniteam', 'SECRETARY', 'AR', 'Organized today, empowered tomorrow.')
) as candidate(name, group_name, position, initials, description)
